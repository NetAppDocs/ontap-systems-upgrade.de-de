...
* link:upgrade/upgrade-decide-to-use-this-guide.html["Speicher verschieben"]
+
Sie können unterbrechungsfrei von einem AFF A250 auf ein AFF A400 oder von einem FAS2820 auf ein Ersatzsystem upgraden, indem Sie die ursprünglichen Knoten in Laufwerksschächte umwandeln und dann die Laufwerksschächte mit den Ersatzknoten verbinden, um den Onboard-Speicher zu verschieben.
