...
NOTE: Sie können auch ein Upgrade einer AFF A800 auf eine AFF A70 oder AFF A90 mithilfe der Aggregatverschiebung durchführen. link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-app-9151/index.html["Weitere Informationen ."].
