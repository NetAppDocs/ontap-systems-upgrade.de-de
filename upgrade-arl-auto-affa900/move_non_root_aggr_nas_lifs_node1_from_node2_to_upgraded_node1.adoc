...
summary: Vergewissern Sie sich, dass die NAS-Daten-LIFs auf node1 während eines Upgrades von AFF A700 auf AFF A900 von node2 auf node1 verschoben werden. 
---
