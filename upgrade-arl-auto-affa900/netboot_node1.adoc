...
. Warten Sie, bis node1 jetzt auf dem Controller-Modul ASA A900, AFF A900 oder FAS9500 ausgeführt wird, um die Boot-Menüoptionen wie unten gezeigt zu starten und anzuzeigen:
+
[listing]
----
