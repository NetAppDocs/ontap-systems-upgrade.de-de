...
summary: Bereiten Sie die Nodes vor und führen Sie eine Reihe von Vorabprüfungen bei einem AFF A700 auf AFF A900 Upgrade durch. 
---
...
[role="lead"]
In Phase 1 müssen Sie die Nodes auf das Upgrade vorbereiten und eine Reihe von Vorabprüfungen durchführen. Sie müssen sich auch auf den Netzboot der neuen Controller vorbereiten.
...
+
Sie müssen die Ausgabe der folgenden Befehle einzeln ausführen und speichern:
...
NOTE: Wenn NetApp Volume Encryption mit Onboard Key Manager verwendet wird, halten Sie die Schlüsselmanager-Passphrase bereit, um die Resynchronisierung des Schlüsselmanagers später im Verfahren abzuschließen.
...
Siehe link:other_references.html["Quellen"] Um auf die _NetApp Support Site_ zu verlinken, erhalten Sie neue 2-stellige Lizenzschlüssel für 9.10.1 oder höher. Die Schlüssel sind im Abschnitt „_My Support_“ unter „_Software licenses_“ verfügbar. Falls auf der Website keine Lizenzschlüssel vorhanden ist, wenden Sie sich an Ihren NetApp Ansprechpartner.
