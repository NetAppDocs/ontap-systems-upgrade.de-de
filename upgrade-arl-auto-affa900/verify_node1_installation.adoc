...
.Über diese Aufgabe
Nachdem Sie node1 mit dem Ersatz-Controller-Modul gestartet haben, müssen Sie überprüfen, ob es korrekt installiert ist. Sie müssen warten, bis node1 dem Quorum beitreten und dann den Controller-Ersatzvorgang fortsetzen.
