...
summary: 'Beheben Sie Fehler bei der Aggregatverschiebung, die auftreten können, wenn Sie Befehle zum Controller-Upgrade mit ONTAP 9.15.1 oder höher verwenden `system controller replace` .' 
---
