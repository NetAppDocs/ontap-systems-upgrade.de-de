...
summary: 'Fehler bei der Aggregatverschiebung beheben, die bei der Verwendung von  `system controller replace` Befehlen zum Upgrade auf Controller, die in ONTAP 9.15.1 oder später eingeführt wurden, auftreten können.' 
---
