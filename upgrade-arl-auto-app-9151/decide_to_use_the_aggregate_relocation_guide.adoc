...
|===
+
Um ein in der obigen Tabelle aufgeführtes Upgrade durchzuführen, siehe link:other_references.html["Quellen"] zum Link zu _Verwenden Sie die Befehle "system controller replace", um Controller-Modelle im selben Chassis zu aktualisieren_.
