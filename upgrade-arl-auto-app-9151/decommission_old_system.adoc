...
summary: 'NetApp sollte darüber informiert werden, dass das alte System nach dem Upgrade auf Controller, die in ONTAP 9.15.1 oder später eingeführt wurden, nicht mehr in Betrieb ist, indem  `system controller replace` Befehle verwendet werden.' 
---
...
Nach der Stilllegung des alten Systems, link:resume_snapmirror_operations.html["Wiederaufnahme der SnapMirror-Vorgänge"].
