...
summary: 'Lassen Sie NetApp wissen, dass das alte System nach dem Aktualisieren der Controller, auf denen ONTAP 9.15.1 oder höher ausgeführt wird, über die Befehle nicht mehr funktioniert `system controller replace` .' 
---
