...
summary: 'LIFs sind nach der Migration in Phase 2, Phase 3 oder Phase 5 nicht online, wenn ein Upgrade auf Controller durchgeführt wird, die in ONTAP 9.15.1 oder später eingeführt wurden, durch die Verwendung von  `system controller replace` Befehlen.' 
---
