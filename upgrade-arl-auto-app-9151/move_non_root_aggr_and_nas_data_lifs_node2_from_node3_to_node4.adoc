...
summary: 'Es sollte überprüft werden, ob die NAS-Daten-LIFs von Node2, die sich auf Node3 befinden, beim Upgrade auf die in ONTAP 9.15.1 oder später eingeführten Controller mithilfe von  `system controller replace` Befehlen von Node3 auf Node4 verschoben werden.' 
---
