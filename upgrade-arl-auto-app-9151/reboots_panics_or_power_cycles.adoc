...
summary: 'Das System kann während verschiedener Phasen beim Upgrade auf Controller, die in ONTAP 9.15.1 oder später eingeführt wurden, mithilfe von  `system controller replace` Befehlen abstürzen, neu starten, in Panik geraten oder einen Stromzyklus durchlaufen.' 
---
