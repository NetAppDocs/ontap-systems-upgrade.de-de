...
summary: 'Fehlgeschlagene oder abgelehnte Aggregate werden beim Upgrade auf Controller, die in ONTAP 9.15.1 oder höher eingeführt wurden, mithilfe von  `system controller replace` Befehlen manuell auf node2 verschoben.' 
---
...
Nach dem Verschieben fehlgeschlagener oder abgelehnter Aggregate auf node2, link:retire_node1.html["Node1 außer Betrieb nehmen"].
