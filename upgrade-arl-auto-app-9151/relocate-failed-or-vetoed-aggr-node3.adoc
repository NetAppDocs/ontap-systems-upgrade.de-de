...
summary: 'Fehlgeschlagene oder abgelehnte Aggregate werden beim Upgrade auf Controller, die in ONTAP 9.15.1 oder höher eingeführt wurden, mithilfe von  `system controller replace` Befehlen manuell auf node3 verschoben.' 
---
...
Nach dem Verschieben fehlgeschlagener oder abgelehnter Aggregate auf node3, link:retire_node2.html["Node2 außer Betrieb nehmen"].
