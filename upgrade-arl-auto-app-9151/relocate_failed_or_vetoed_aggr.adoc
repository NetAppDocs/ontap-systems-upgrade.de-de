...
summary: 'Verschieben Sie fehlerhafte oder Veto-Aggregate manuell, wenn Sie Controller mit ONTAP 9.15.1 oder höher mithilfe von Befehlen aktualisieren `system controller replace` .' 
---
