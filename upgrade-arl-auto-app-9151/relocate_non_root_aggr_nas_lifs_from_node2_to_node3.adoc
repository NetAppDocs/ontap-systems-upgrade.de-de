...
summary: 'Verschieben Sie die nicht-Root-Aggregate von node2 mithilfe von Befehlen auf node3, wenn Sie Controller mit ONTAP 9.15.1 oder höher aktualisieren `system controller replace` .' 
---
