...
summary: 'Falls erforderlich, das neue Controller-Modul für NVE oder NAE konfigurieren, wenn auf Controller aktualisiert wird, die in ONTAP 9.15.1 oder später eingeführt wurden, mithilfe von  `system controller replace` Befehlen.' 
---
...
Nach der Einrichtung der NetApp Volumen- oder Aggregatverschlüsselung auf dem neuen Controller-Modul, link:decommission_old_system.html["Das alte System außer Betrieb nehmen"].
