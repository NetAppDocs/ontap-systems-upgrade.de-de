...
Nach der Überprüfung auf MetroCluster-Konfigurationsfehler link:verify_switchover_healing_switchback.html["Überprüfung von Umschaltung, Heilung und Rückschaltung"].
