...
+
Für die Aktualisierung von MetroCluster IP-Konfigurationen siehe link:other-references.html["Quellen"] den Link zu _MetroCluster Upgrade and Expansion_.
...
^4^Die folgende Tabelle zeigt die unterstützten ONTAP Versionen für die Controller-Upgrade-Kombinationen.
...
| FAS2720 | 9.13.1 oder später | FAS2820 | 9.13.1 oder später 


| FAS2760 | 9.11.1P7 oder früher | FAS2820 | 9.13.1 oder später 
...
Nachdem Sie entschieden haben, ob Sie dieses ARL-Verfahren anwenden möchten, informieren Sie sich über die link:required_tools_and_documentation.html["benötigte Werkzeuge und Dokumentation"].
