...
Die Größe aller definierten Aggregate und die Anzahl der vom ursprünglichen System unterstützten Festplatten müssen überprüft werden. Anschließend ist die Aggregatgröße und die Anzahl der unterstützten Festplatten mit der Aggregatgröße und der Anzahl der vom neuen System unterstützten Festplatten zu vergleichen. Siehe link:other-references.html["Quellen"] für einen Link zum _Hardware Universe_, in dem diese Informationen verfügbar sind. Die Aggregatgröße und die Anzahl der vom neuen System unterstützten Festplatten müssen mindestens so groß sein wie die Aggregatgröße und die Anzahl der vom ursprünglichen System unterstützten Festplatten.
...
Nach Durchsicht der Richtlinien für die Aufrüstung von Controllern mit ARL, link:verify_health_of_metrocluster_config.html["Überprüfen Sie den Zustand der MetroCluster Konfiguration"].
