...
NOTE: Wenn NetApp Volume Encryption mit Onboard Key Manager (OKM) verwendet wird, halten Sie die Schlüsselmanager-Passphrase bereit, um die Resynchronisierung des Schlüsselmanagers später im Verfahren abzuschließen.
