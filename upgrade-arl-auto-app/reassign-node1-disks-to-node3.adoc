...
.Schritte
. [[reassign-node1-node3-app-step1]]Überprüfen Sie, ob Knoten1 im Startmenü angehalten wurde.  Weisen Sie die Datenträger von Knoten1 Knoten3 neu zu:
+
...
+
** Ausführen<<reassign-node1-node3-app-step3,Schritt 3>> Zu<<reassign-node1-node3-app-step8,Schritt 8>> auf Knoten3
** Gehe zum Abschnittlink:verify_node3_installation.html["Überprüfen Sie die Installation von node3"]
...
Nach der Neuzuordnung der Festplatten von node1 zu node3, link:verify_node3_installation.html["Überprüfen Sie die Installation von node3."].
