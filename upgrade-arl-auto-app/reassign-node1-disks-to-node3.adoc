...
.Schritte
. [[resuceif-node1-node3-App-step1]]Gehen Sie zum Startmenü und wählen Sie mit 22/7 die versteckte Option aus `boot_after_controller_replacement`. Geben Sie an der Eingabeaufforderung node1 ein, um die Festplatten von node1 node3 wie im folgenden Beispiel neu zuzuweisen.
+
