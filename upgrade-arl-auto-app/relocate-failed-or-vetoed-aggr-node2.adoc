...
summary: 'Manuelles Verschieben von fehlgeschlagenen oder abgelehnten Aggregaten auf Knoten2 beim Upgrade von Controllern mit ONTAP 9.8 oder höher mithilfe von `system controller replace` Befehle.' 
---
...
Nach der Verlagerung fehlgeschlagener oder abgelehnter Aggregate, link:retire_node1.html["Node1 außer Betrieb nehmen"].
