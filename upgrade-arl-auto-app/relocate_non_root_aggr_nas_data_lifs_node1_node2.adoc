...
Nach der Verschiebung der Nicht-Root-Aggregate und der NAS-Daten-LIFs, die sich im Besitz von node1 befinden, zu node2, link:relocate-failed-or-vetoed-aggr-node2.html["gescheiterte oder abgelehnte Aggregate verlagern"].
