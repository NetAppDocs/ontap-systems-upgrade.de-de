...
Nach der Verschiebung der Nicht-Root-Aggregate und der NAS-Daten-LIFs von Node2 auf Node3, link:relocate-failed-or-vetoed-aggr-node3.html["gescheiterte oder abgelehnte Aggregate verlagern"].
