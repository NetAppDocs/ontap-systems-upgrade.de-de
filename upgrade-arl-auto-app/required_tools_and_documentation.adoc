...
Nachdem Sie die benötigten Werkzeuge und die Dokumentation geprüft haben, informieren Sie sich über die link:guidelines_for_upgrading_controllers_with_arl.html["Richtlinien zum Upgraden von Controllern mit ARL"].
