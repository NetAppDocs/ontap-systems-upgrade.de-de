...
Nach der Wiederherstellung der Schlüsselverwaltungskonfiguration auf node3, link:move_non-root_aggr_and_nas_data_lifs_node1_from_node2_to_node3.html["Nicht-Root-Aggregate und NAS-Daten-LIFs, die node1 gehören, von node2 nach node3 verschieben"].
