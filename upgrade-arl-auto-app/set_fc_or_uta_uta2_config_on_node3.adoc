...
** Wenn node3 keine UTA/UTA2-Karte oder Onboard-Ports UTA/UTA2 hat, überspringen Sie den Abschnitt  and configure UTA/UTA2 ports on node3 Und gehen Sie zum Abschnitt link:verify_node3_installation.html["Überprüfen Sie die Installation von node3"].
...
** Wenn node3 eine UTA/UTA2-Karte oder Onboard-Ports zu UTA/UTA2 hat, fahren Sie mit dem Abschnitt fort  and configure UTA/UTA2 ports on node3.
** Wenn node3 keine UTA/UTA2-Karte oder Onboard-Ports UTA/UTA2 hat, überspringen Sie den Abschnitt  and configure UTA/UTA2 ports on node3 Und kehren Sie zum Abschnitt _Installieren und Booten node3_ zurück und fahren Sie bei fort link:install_boot_node3.html#step23["Schritt 23"].
