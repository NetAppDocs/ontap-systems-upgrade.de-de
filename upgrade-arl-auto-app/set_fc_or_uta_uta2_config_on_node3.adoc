...
Falls node3 keine Onboard-FC-Ports, Onboard-UTA/UTA2-Ports oder eine UTA/UTA2-Karte besitzt (zum Beispiel AFF und FAS Systeme, die in ONTAP 9.15.1 oder später eingeführt wurden), und ein System mit Storage Disks aktualisiert wird, kann zu link:reassign-node1-disks-to-node3.html["Weisen Sie node1-Festplatten Knoten 3 neu zu"] übergegangen werden.



[[step-1-configure-fc-ports-on-node3]]
[[configure-fc-ports-on-node3]]
== Schritt 1: FC-Ports auf node3 konfigurieren
...
.Über diese Aufgabe
Sie können diesen Abschnitt überspringen, wenn Ihr System keine FC-Konfigurationen aufweist. Wenn Ihr System über integrierte UTA/UTA2-Ports oder eine UTA/UTA2-Karte verfügt, konfigurieren Sie diese in <<check-config-uta-uta2-node3,UTA/UTA2-Ports in node3 prüfen und konfigurieren>>.
...
| Verfügt über eine UTA/UTA2-Karte oder UTA/UTA2-Onboard-Ports | Gehe zu <<check-config-uta-uta2-node3,UTA/UTA2-Ports in node3 prüfen und konfigurieren>> 
...
== Schritt 2: UTA/UTA2-Ports auf node3 prüfen und konfigurieren
