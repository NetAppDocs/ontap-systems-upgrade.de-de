...
Nach Überprüfung des einwandfreien Zustands der MetroCluster-Konfiguration, link:check_for_metrocluster_config_errors.html["Auf MetroCluster-Konfigurationsfehler prüfen"].
