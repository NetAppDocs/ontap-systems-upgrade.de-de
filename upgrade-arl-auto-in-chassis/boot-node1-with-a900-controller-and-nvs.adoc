...
+
Geben Sie die Passphrase und die Sicherungsinformationen ein, die Sie zuvor im Verfahren notiert haben. Siehe link:manage-storage-encryption-using-okm.html["Management der Storage-Verschlüsselung mit dem Onboard Key Manager"].
