...
[role="lead"]
Node1 mit den Ersatzmodulen ist nun startbereit.  Die unterstützten Ersatzmodule sind in der folgenden Liste aufgeführt:link:decide_to_use_the_aggregate_relocation_guide.html#supported-systems-in-chassis["Unterstützte Systeme Matrix"] Die
