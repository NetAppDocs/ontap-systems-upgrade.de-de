...
summary: Die Cluster-, HA-, Speicher- und Datenverbindungen, die zuvor mit dem AFF A800 node1 verbunden waren, werden mit dem neu installierten AFF A90 oder AFF A70 node1 verbunden. 
---
...
Nach der Verkabelung von Node1 für gemeinsam genutztes Cluster-HA und Storage, link:boot-node1-with-a900-controller-and-nvs.html["Booten Sie Node1 mit den Ersatzsystemmodulen"].
