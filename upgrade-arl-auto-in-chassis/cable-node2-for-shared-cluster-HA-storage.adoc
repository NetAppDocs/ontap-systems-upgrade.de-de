...
summary: Die Cluster-, HA-, Speicher- und Datenverbindungen, die zuvor mit dem AFF A800 node2 verbunden waren, werden mit dem neu installierten AFF A90 oder AFF A70 node2 verbunden. 
---
...
Nach der Verkabelung von Node2 für gemeinsam genutztes Cluster-HA und Storage, link:boot-node2-with-a900-controller-and-nvs.html["Booten Sie Node2 mit den Ersatzsystemmodulen"].
