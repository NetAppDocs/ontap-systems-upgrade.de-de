...
Nachdem Sie sich für die Anwendung dieses ARL-Verfahrens entschieden haben, link:required-tools-and-documentation.html["Informieren Sie sich über die benötigten Werkzeuge und die Dokumentation"].
