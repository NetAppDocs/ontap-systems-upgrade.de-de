...
* Dieses Verfahren ist komplex und setzt fortgeschrittene ONTAP Administrationskenntnisse voraus. Sie sollten die link:guidelines_for_upgrading_controllers_with_arl.html["Richtlinien zum Upgraden von Controllern"] und link:overview_of_the_arl_upgrade.html["ARL-Upgradesequenz"] sorgfältig lesen und verstehen, bevor Sie mit dem Upgrade beginnen.
