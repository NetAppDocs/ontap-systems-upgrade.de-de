...
| link:verify-upgrade-hardware.html["Phase 1: Upgrade vorbereiten"]  a| 
...
| link:relocate-non-root-aggr-and-nas-data-lifs-node1-node2.html["Phase 2: Ressourcen verlagern und Knoten in den Ruhestand zurücknehmen 1"]  a| 
...
| link:relocate-non-root-aggr-nas-lifs-from-node2-to-node1.html["Phase 4: Ressourcen verlagern und Knoten zurücknehmen 2"]  a| 
...
| link:install-aff-a30-a50-c30-c50-node2.html["Phase 5: Installieren Sie die Ersatzsystemmodule für node2"]  a| 
...
| link:cable-node2-for-shared-cluster-HA-storage.html["Stufe 6: Starten Sie Node2 mit den Ersatz-Systemmodulen"]  a| 
