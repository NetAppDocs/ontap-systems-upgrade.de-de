...
summary: Fehlgeschlagene oder abgelehnte Aggregate werden bei der Aktualisierung von Controller-Modellen im selben Chassis mit ARL manuell auf node1 verschoben. 
---
...
Nach dem Verschieben fehlgeschlagener oder abgelehnter Aggregate auf Knoten 1, link:retire-node2.html["Node2 außer Betrieb nehmen"].
