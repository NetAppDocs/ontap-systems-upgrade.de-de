...
Nach der Verschiebung der Nicht-Root-Aggregate und der NAS-Daten-LIFs von Knoten 2 auf Knoten 1, link:relocate-failed-or-vetoed-aggr-node1.html["Fehlgeschlagene oder abgelehnte Aggregate auf node1 verschieben"].
