...
---
= Ersetzen Sie die Controller- und NVRAM-Module von Node1 AFF A700 oder FAS9000
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
== Schritt 4: Installieren Sie das ASA A900, AFF A900 oder FAS9500 Controller-Modul in node1
...
. Nachdem Sie AUTOBOOT unterbrochen haben, bleibt node1 an der LOADER-Eingabeaufforderung stehen. Falls Sie AUTOBOOT nicht rechtzeitig unterbrechen und node1 bereits startet, warten Sie auf die Eingabeaufforderung und drücken Sie Strg+C, um ins Bootmenü zu gelangen. Nachdem der Knoten im Bootmenü angehalten hat, verwenden Sie Option `8`, um den Knoten neu zu starten und AUTOBOOT während des Neustarts zu unterbrechen.
...
Nach der Installation der ASA A900, AFF A900 oder FAS9500 Controller- und NVRAM-Module link:netboot-node1.html["netboot node1"].
