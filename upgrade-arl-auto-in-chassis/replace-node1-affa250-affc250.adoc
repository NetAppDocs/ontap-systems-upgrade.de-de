...
---
= Ersetzen Sie das Controller-Modul AFF A250 oder AFF C250 von node1
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Um das Controller-Modul node1 zu entfernen, entfernen Sie die Kabelmanagement-Vorrichtung und entriegeln Sie die Verriegelungsriegel. Entfernen Sie dann das Controller-Modul aus dem Chassis.
...
Nach der Installation des AFF A30, AFF A50, AFF C30 oder AFF C60 Controller-Moduls, link:netboot-node1.html["netboot node1"].
