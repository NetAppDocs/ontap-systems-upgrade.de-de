...
Nach der Wiederherstellung der Key-Manager-Konfiguration auf Knoten 2, link:verify-rcf-configuration.html["Überprüfen Sie die RCF-Konfiguration auf den Cluster-Switches"].
