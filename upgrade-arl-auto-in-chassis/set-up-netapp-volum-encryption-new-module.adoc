...
summary: Konfigurieren Sie gegebenenfalls das neue Controller-Modul für NVE oder NAE, wenn Sie ARL verwenden, um Controller-Modelle im selben Chassis zu aktualisieren. 
---
...
Nach der Einrichtung der NetApp Volume- oder Aggregatverschlüsselung auf dem neuen Controller-Modul link:decommission-old-system.html["Das alte System außer Betrieb nehmen"].
