...
^2^Wenn Sie auf ein AFF A800 oder ein System aktualisieren, das interne und externe Festplatten unterstützt, müssen Sie die spezifischen Anweisungen für das Root-Aggregat auf internen NVMe-Festplatten befolgen.  Siehelink:reassign-node1-disks-to-node3.html#auto_check3_step9["Weisen Sie node1-Festplatten Knoten 3, Schritt 9, neu zu"] Undlink:reassign-node2-disks-to-node4.html#auto_check_4_step9["Weisen Sie Node2-Festplatten node4, Schritt 9, neu zu"] Die
