...
* Wenn Sie von einem AFF A320-System aktualisieren, können Sie die Controller-Hardware mithilfe von Volume-Verschiebungen aktualisieren oder den technischen Support kontaktieren. Wenn Volume-Verschiebungen in Betracht gezogen werden, siehe link:other-references.html["Quellen"] zum Verweis auf _Upgrade durch Verschieben von Volumes oder Speicher_.
