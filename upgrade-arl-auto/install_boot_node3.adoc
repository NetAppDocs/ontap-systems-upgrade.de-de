...
* Wenn Sie ein System mit einer FC- oder UTA/UTA2-Konfiguration haben,link:set_fc_or_uta_uta2_config_on_node3.html["Legen Sie die FC- oder UTA/UTA2-Konfiguration auf Knoten3 fest"] .
* Wenn Sie keine FC- oder UTA/UTA2-Konfiguration haben,link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1["weisen Sie die Datenträger von Knoten1 Knoten3 neu zu"] damit Knoten3 die Festplatten von Knoten1 erkennen kann.
* Wenn Sie eine MetroCluster Konfiguration haben,link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1["weisen Sie die Datenträger von Knoten1 Knoten3 neu zu"] .
