...
. Wenn NetApp Storage Encryption Drives installiert sind, führen Sie die folgenden Schritte durch.
+
...
| NetApp Storage Encryption (NSE) Laufwerke, die der Self-Encryption-Anforderung von FIPS 140-2 Level 2 entsprechen | `setenv bootarg.storageencryption.support *true*` 
