...
. [[step29]] für MetroCluster Konfigurationen, V-Series Systeme und Systeme mit FlexArray Virtualisierungssoftware, die mit Storage-Arrays verbunden ist, finden Sie den Link:set_fc_or_uta_uta2_config_node4.HTML# Auto_Check_4_step15[UTA/UTA2-Ports auf node4 prüfen und konfigurieren, Schritt 15].
