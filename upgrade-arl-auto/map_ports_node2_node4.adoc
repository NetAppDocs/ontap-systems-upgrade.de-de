...
+
Siehe link:other_references.html["Quellen"], um zu _Netzwerkmanagement_ oder der _ONTAP 9 Command reference_ zu verlinken, und siehe _Konfigurieren von Failover-Einstellungen auf einem LIF_ für weitere Informationen.
