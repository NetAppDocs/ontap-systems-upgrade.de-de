...
summary: 'Erforderliche Referenzinhalte und Websites zur Unterstützung eines Controller-Upgrades unter ONTAP 9.5 zu 9.7 mithilfe von `system controller replace` Befehle.' 
---
= Quellen
:hardbreaks:
:allow-uri-read: 
...
| link:https://docs.netapp.com/us-en/ontap-cli/index.html["ONTAP 9 Befehlsreferenz"^] | Beschreibt die Syntax und Verwendung der unterstützten ONTAP-Befehle. 
...
| link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-app-9151/index.html["Mit den Befehlen „system controller replace“ kann auf die in ONTAP 9.15.1 und später eingeführte Controller-Hardware aktualisiert werden."^] | Beschreibt die erforderlichen Aggregate-Verlagerungsverfahren für ein unterbrechungsfreies Upgrade auf die in ONTAP 9.15.1 und später eingeführten Controller mithilfe von "system controller replace"-Befehlen. 
