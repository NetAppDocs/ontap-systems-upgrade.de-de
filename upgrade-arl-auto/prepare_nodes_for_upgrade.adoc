...
NOTE: Wenn NetApp Volume Encryption mit Onboard Key Manager verwendet wird, halten Sie die Passphrase für Schlüsselmanager bereit, um die Resynchronisierung des Schlüsselmanagers später im Verfahren abzuschließen.
