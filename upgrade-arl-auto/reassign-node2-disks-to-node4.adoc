...
NOTE: Es könnte in dieser Phase ein Fehler auftreten.  Falls ein Fehler auftritt, wiederholen Sie die Teilschritte in<<auto_check_4_step8,Schritt 8>> bis das System normal hochfährt.
