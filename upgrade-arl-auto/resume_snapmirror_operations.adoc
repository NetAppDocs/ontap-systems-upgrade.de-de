...
summary: 'Setzen Sie die SnapMirror Transfers und Beziehungen fort, wenn Sie Controller mit ONTAP 9.5 bis 9.7 aktualisieren `system controller replace` Befehle.' 
---
