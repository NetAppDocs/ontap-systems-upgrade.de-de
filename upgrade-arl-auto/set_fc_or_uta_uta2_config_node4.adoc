...
summary: Die Onboard FC-Ports von Node4, die UTA- und UTA2-Ports oder die UTA- und UTA2-Karte können beim Upgrade von Controllern mit ONTAP 9.5 auf 9.7 mithilfe von system controller replace-Befehlen konfiguriert werden. 
---
