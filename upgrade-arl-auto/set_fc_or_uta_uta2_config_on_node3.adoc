...
+
** Falls Knoten 3 über eine UTA/UTA2-Karte oder UTA/UTA2-Onboard-Ports verfügt, gehen Sie zu <<check-config-uta-uta2-node3,UTA/UTA2-Ports in node3 prüfen und konfigurieren>>.
** Falls node3 keine UTA/UTA2-Karte oder UTA/UTA2-Onboard-Ports besitzt, überspringen Sie <<check-config-uta-uta2-node3,UTA/UTA2-Ports in node3 prüfen und konfigurieren>> und fahren Sie mit link:reassign-node1-disks-to-node3.html["Weisen Sie node1-Festplatten Knoten 3 neu zu"] fort.
