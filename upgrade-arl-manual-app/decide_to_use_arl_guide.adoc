...
Siehe link:other-references.html["Quellen"] für einen Link zum _ONTAP 9 Documentation Center_, wo auf die Produktdokumentation für ONTAP 9 zugegriffen werden kann.
...
Nachdem entschieden wurde, ob dieses ARL-Verfahren angewendet werden soll, link:arl_upgrade_workflow.html["Überprüfen Sie den ARL-Upgrade-Workflow"].
