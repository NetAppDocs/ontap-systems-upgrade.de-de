...
summary: Lassen Sie NetApp wissen, dass das alte System nach Abschluss eines manuellen ARL Upgrades bei Controllern mit ONTAP 9.8 oder höher nicht mehr funktioniert. 
---
...
Nach der Stilllegung des alten Systems, link:resume_snapmirror_ops.html["Wiederaufnahme der SnapMirror-Vorgänge"].
