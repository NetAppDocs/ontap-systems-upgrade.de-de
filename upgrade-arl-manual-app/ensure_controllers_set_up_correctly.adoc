...
Nachdem bestätigt wurde, dass die neuen Controller korrekt eingerichtet sind, link:set_up_storage_encryption_new_controller.html["Speicherverschlüsselung auf dem neuen Controllermodul einrichten"].
