...
+
** Für MetroCluster Konfigurationen, die ONTAP 9.7 oder früher ausführen, siehe link:other-references.html["Quellen"] zum Link _Using Aggregate Relocation to Manually Upgrade Controller Hardware Running ONTAP 9.7 or Earlier_.
** Für MetroCluster IP Konfigurationen und zusätzliche Upgrade-Optionen für Fabric MetroCluster Konfigurationen siehe link:other-references.html["Quellen"] den Link zum Inhalt „MetroCluster Upgrade und Erweiterung“.




.Was kommt als Nächstes?
Nachdem ich von diesem ARL-Verfahren erfahren hatte, link:decide_to_use_arl_guide.html["entscheiden, ob dieses ARL-Verfahren angewendet werden soll"].
