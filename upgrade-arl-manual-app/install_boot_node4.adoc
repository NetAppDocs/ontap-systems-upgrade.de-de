...
+
Der  `disk reassign`Befehl weist nur diejenigen Datenträger neu zu, für die  `_node2_sysid_`der aktuelle Besitzer ist.
...
Nach der Installation und dem Start von Node4, link:set_fc_uta_uta2_config_node4.html["Legen Sie die FC- oder UTA/UTA2-Konfiguration auf Knoten4 fest"].
