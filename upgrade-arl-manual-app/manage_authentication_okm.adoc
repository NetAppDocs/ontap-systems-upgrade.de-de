...
Nach der Verwaltung von Authentifizierungsschlüsseln mithilfe des Onboard Key Managers, link:quiesce_snapmirror_relationships.html["die SnapMirror-Beziehungen beruhigen"].
