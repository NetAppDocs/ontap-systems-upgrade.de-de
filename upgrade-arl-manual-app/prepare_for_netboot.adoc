...
* Siehe link:other-references.html["Quellen"] für einen Link zur _NetApp Support Site_ und zum Herunterladen der notwendigen Systemdateien für Ihre Plattform und die richtige Version von ONTAP.
...
Nach der Vorbereitung für den Netboot, link:relocate_non_root_aggr_node1_node2.html["Nicht-Root-Aggregate von node1 zu node2 verschieben"].
