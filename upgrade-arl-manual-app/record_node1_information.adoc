...
+
Die Broadcast-Domänen müssen im weiteren Verlauf des Verfahrens den neuen Ports auf dem neuen Controller zugeordnet werden.
...
Nach der Aufzeichnung der node1-Informationen, link:retire_node1.html["Node1 außer Betrieb nehmen"].
