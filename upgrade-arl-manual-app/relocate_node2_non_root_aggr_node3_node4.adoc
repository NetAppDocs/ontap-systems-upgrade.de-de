...
Weitere Informationen zu Befehlen für die Verschiebung von Speicheraggregaten finden Sie in link:other_references.html["Quellen"] _Disk and aggregate management with the CLI_ und der _ONTAP 9 Command reference_.
...
Nach der Verschiebung der Nicht-Root-Aggregate von node2 von node3 nach node4, link:manage_authentication_kmip.html["Authentifizierung mit KMIP-Servern verwalten"].
