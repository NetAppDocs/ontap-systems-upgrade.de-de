...
Wechseln Sie zum link:other-references.html["Quellen"] Abschnitt, um auf die Liste der für dieses Upgrade erforderlichen Referenzdokumente zuzugreifen.

.Was kommt als Nächstes?
Nach Durchsicht der benötigten Werkzeuge und Dokumentation, link:worksheet_information_before_during_upgrade.html["Die ursprünglichen Knoteninformationen zur Verwendung während des Upgrades aufzeichnen"].
