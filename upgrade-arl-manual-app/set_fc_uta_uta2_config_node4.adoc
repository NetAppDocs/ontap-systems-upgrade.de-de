...
summary: Die Onboard FC-Ports von Node4, die UTA- und UTA2-Ports oder die UTA- und UTA2-Karte werden während eines manuellen ARL-Upgrades auf Controllern mit ONTAP 9.8 oder höher konfiguriert. 
---
...
Nachdem die FC- oder UTA/UTA2-Konfiguration auf node4 eingerichtet wurde, link:map_ports_node2_node4.html["Ports von node2 zu node4 zuweisen"].
