...
Nach der Einrichtung der Speicherverschlüsselung auf dem neuen Controller-Modul, link:set_up_netapp_encryption_on_new_controller.html["Richten Sie die NetApp Volume- oder Aggregatverschlüsselung auf dem neuen Controller-Modul ein"].
