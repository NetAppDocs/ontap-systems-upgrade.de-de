...
Nach der Aufzeichnung der ursprünglichen Knoteninformationen, link:determine_aggregates_on_internal_drives.html["feststellen, ob der Controller Aggregate auf internen Festplattenlaufwerken hat"].
