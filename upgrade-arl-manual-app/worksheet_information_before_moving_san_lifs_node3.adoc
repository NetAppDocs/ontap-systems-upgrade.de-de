...
Nach der Aufzeichnung der  `adapter` und  `switch-port` Informationen für jedes LIF, link:relocate_non_root_aggr_node2_node3.html["Nicht-Root-Aggregate von node2 zu node3 verschieben"].
