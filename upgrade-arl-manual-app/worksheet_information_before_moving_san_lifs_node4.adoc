...
Nach der Aufzeichnung der  `adapter` und  `switch-port` Informationen für jedes LIF, link:relocate_node2_non_root_aggr_node3_node4.html["Verschieben Sie die Nicht-Root-Aggregate von node2 von node3 zu node4"].
