...
summary: Lassen Sie NetApp wissen, dass das alte System nach Abschluss eines manuellen ARL Upgrades bei Controllern mit ONTAP 9.7 oder einer älteren Version nicht mehr funktioniert. 
---
