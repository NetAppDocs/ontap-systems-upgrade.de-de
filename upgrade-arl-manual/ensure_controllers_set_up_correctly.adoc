...
+
Gehen Sie zu link:other_references.html["Quellen"], um auf die _System Administration Reference_ für Informationen zu den SPs und auf die _ONTAP 9 Command reference_ für detaillierte Informationen zum  `system service- processor network modify` Befehl zu verlinken.
