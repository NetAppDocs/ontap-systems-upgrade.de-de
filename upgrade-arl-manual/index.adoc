...
* Dieses Verfahren gilt für MetroCluster vier-Node- und acht-Node-Konfigurationen mit ONTAP 9.5 und älteren Versionen. Für MetroCluster Konfigurationen mit ONTAP 9.6 und neueren Versionen siehe link:other-references.html["Quellen"] den Link zu _Using "system controller replace" Commands to Upgrade Controller Hardware Running ONTAP 9.5 to ONTAP 9.7_.
