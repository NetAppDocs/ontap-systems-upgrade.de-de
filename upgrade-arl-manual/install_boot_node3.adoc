...
----
. [[man_install3_step5]]Wenn die Warnmeldung in angezeigt wird ,Schritt 4, Nehmen Sie die folgenden Aktionen:
+
...
.. Kehren Sie zu diesem Abschnitt zurück, und führen Sie die verbleibenden Schritte aus. Beginnen Sie mit ,Schritt 7.
...
.. Wenn die Warnmeldung in angezeigt wird ,Schritt 4, Folgen Sie den Anweisungen in ,Schritt 5
...
| Hat _Not_ die richtige oder aktuelle ONTAP-Version auf node3 | Gehen Sie zu ,Schritt 20. 
...
. [[man_install3_step42]]Überprüfen Sie, ob die Partner-System-ID korrekt festgelegt ist, wie in angegeben ,Schritt 28 Schalter unter -p:
+
