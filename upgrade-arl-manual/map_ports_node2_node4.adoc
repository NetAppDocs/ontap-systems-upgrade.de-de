...
+
Weitere Informationen finden Sie, indem Sie link:other_references.html["Quellen"] auf _Network Management_ oder die _ONTAP 9 Command reference_ verlinken und zu _Configuring failover settings on a LIF_ gehen.
