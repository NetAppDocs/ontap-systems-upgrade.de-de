...
.Schritte
. link:send_custom_autosupport_message_prior_reconfig_switches.html["Senden Sie vor der Neukonfiguration der Switches eine benutzerdefinierte AutoSupport Meldung"]
