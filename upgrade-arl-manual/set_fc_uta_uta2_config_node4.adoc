...
summary: Die Onboard-FC-Ports von node4, die UTA- und UTA2-Ports oder die UTA- und UTA2-Karte werden während eines manuellen ARL-Upgrades auf Controllern mit ONTAP 9.7 oder früher konfiguriert. 
---
