...
.Schritt
Siehe link:other-references.html["Quellen"] für einen Link zum Abschnitt _MetroCluster Management and Disaster Recovery_ sowie die Verfahren für vereinbarte Umschaltung, Wiederherstellung und Rückschaltung.
