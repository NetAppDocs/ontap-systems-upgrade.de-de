...
summary: Informationen zur Verwendung der Aggregatverlagerung zur Aktualisierung von AFF-, ASA- oder FAS-Controller-Hardware. 
---
= Hier finden Sie den Einstieg: Eine ARL Upgrade-Prozedur für AFF, ASA oder FAS Controller-Hardware auswählen.
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
AFF-, ASA- oder FAS-Controller-Hardware kann unterbrechungsfrei mit Aggregate Relocation (ARL) aktualisiert werden. Weitere Methoden zur Aktualisierung der Controller-Hardware sind unter link:../upgrade/upgrade-decide-to-use-this-guide.html["Upgrade durch Verschieben von Volumes oder Storage"] zu finden.
...
== Upgrade auf Systeme, die in ONTAP 9.15.1 oder höher eingeführt wurden

Wenn Ihr Upgrade-Szenario in der folgenden Matrix der unterstützten Systeme aufgeführt ist, gehen Sie zu link:../upgrade-arl-auto-app-9151/index.html["Mit den Befehlen „system controller replace“ kann auf die in ONTAP 9.15.1 oder später eingeführte Controller-Hardware aktualisiert werden."], um das Upgrade-Verfahren zu starten.
...
| AFF A70 | AFF A90 | 9.18.1 und später 


| AFF A30 | AFF A50 | 9.18.1 und später 


| AFF A20 | AFF A30, AFF A50 | 9.18.1 und später 


| AFF C30 | AFF C60 | 9.18.1 und später 


| FAS70 | FAS90 | 9.18.1 und später 
