...
[role="lead"]
Konvertieren Sie AFF A150, AFF A220 oder FAS2820 node2 in ein Laufwerksgehäuse und verbinden Sie es mit node4, bevor Sie die Laufwerke von node2 zu node4 neu zuweisen. Node1 und node2 sind die Controller innerhalb des Laufwerksgehäuses.
