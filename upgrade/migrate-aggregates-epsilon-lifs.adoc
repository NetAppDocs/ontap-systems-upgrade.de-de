...
[role="lead"]
Migrieren Sie die Datenaggregate, Epsilon und logischen Schnittstellen (LIFs) auf AFF A150, AFF A220 oder FAS2820 node1 zu node4.
...
link:convert-node1-to-drive-shelf.html["Konvertieren Sie Knoten 1 in ein Laufwerk-Shelf und verbinden Sie es mit Knoten 3"]
