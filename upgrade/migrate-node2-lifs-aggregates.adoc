...
summary: 'Migrieren Sie die logischen Schnittstellen (LIFs) und Datenaggregate auf node2 zu node1, bevor Sie node2 in ein Laufwerksgehäuse umwandeln.' 
---
...
[role="lead"]
Migrieren Sie die logischen Schnittstellen (LIFs) und Datenaggregate auf AFF A150, AFF A220 oder FAS2820 node2 zu node1, bevor Sie node2 in ein Laufwerksgehäuse umwandeln.

.Bevor Sie beginnen
Vergewissern Sie sich, dass Sie die folgenden Anforderungen erfüllen:

* Die Original- und Ersatzsteuerungen haben nach Möglichkeit dieselbe ONTAP-Version und denselben Patchstand. Siehe  https://hwu.netapp.com["NetApp Hardware Universe"^] für unterstützte ONTAP-Versionen.
...
.Schritte
Führen Sie diese Schritte auf node1 durch.
...
link:convert-node2-to-drive-shelf.html["Konvertieren Sie Node 2 in ein Laufwerk-Shelf und verbinden Sie ihn mit node 4"]
