...
summary: Nach der Umwandlung von AFF A150, AFF A220 oder FAS2820 node1 in ein Laufwerksgehäuse und dem Anschluss an node3 ordnen Sie die Laufwerke, die zuvor zu node1 gehörten, node3 neu zu. 
---
...
[role="lead"]
Weisen Sie die Laufwerke, die zuvor AFF A150, AFF A220 oder FAS2820 node1 zugewiesen waren, node3 neu zu.
