...
summary: Nach der Umwandlung von AFF A150, AFF A220 oder FAS2820 node2 in ein Laufwerksgehäuse und dem Anschluss an node4 ordnen Sie die Laufwerke, die zuvor zu node2 gehörten, node4 neu zu. 
---
...
[role="lead"]
Weisen Sie die Laufwerke, die zuvor zu AFF A150, AFF A220 oder FAS2820 node2 gehörten, node4 zu.
