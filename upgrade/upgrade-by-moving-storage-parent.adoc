...
---
= Erfahren Sie mehr über Upgrades durch Verschieben von Speicher
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Nachdem Sie sich über Upgrades durch Speicherverlagerung informiert haben, link:upgrade-prepare-when-moving-storage.html["Vorbereitung auf das Upgrade"].
