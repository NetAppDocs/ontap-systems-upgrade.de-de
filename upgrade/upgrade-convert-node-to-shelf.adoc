...
Nach der Umwandlung eines ursprünglichen Knotens in ein Laufwerksgehäuse, link:upgrade-attach-shelves-reassign-disks.html["Speicherregale anschließen und die Festplattenzugehörigkeit neu zuweisen"].
