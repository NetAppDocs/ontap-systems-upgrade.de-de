...
* link:upgrade_aff_a250_to_aff_a400_ndu_upgrade_workflow.html["Erfahren Sie mehr über die Umwandlung von AFF A250 in ein Laufwerksschacht und die Verschiebung des Speichers auf AFF A400"] (unterbrechungsfreies Verfahren)
* link:convert-to-drive-shelf.html["Upgrade von AFF A150, AFF A220 oder FAS2820 durch Umwandlung in ein Laufwerksgehäuse"] (unterbrechungsfreies Verfahren)
