...
Nach der Installation und dem Zusammenschluss der neuen Knoten, link:upgrade_move_linux_iscsi_hosts_to_new_nodes.html["Linux iSCSI Hosts auf die neuen Knoten verschieben"].
