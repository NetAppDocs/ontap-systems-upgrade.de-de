...
Nach dem Verschieben der internen Laufwerke vom ursprünglichen Knoten, link:upgrade-attach-shelves-reassign-disks.html["Speicherregale anschließen und die Festplattenzugehörigkeit neu zuweisen"].
