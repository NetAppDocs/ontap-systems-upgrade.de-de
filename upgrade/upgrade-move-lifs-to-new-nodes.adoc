...
Nach dem Verschieben von Nicht-SAN-Daten-LIFs und Cluster-Management-LIFs link:upgrade_move_delete_recreate_san_lifs.html["SAN LIFs verschieben, löschen oder erstellen"].
