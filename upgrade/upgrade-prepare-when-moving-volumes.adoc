...
Nach der Vorbereitung des Upgrades, link:upgrade-install-and-join-new-nodes-move-vols.html["Die neuen Knoten werden installiert und dem Cluster hinzugefügt."].
