...
Nach dem Herunterfahren der ursprünglichen Knoten, link:upgrade-remove-disk-ownership-new-nodes.html["Eigentumsrechte an den an die neuen Knoten angeschlossenen Festplatten entfernen"].
