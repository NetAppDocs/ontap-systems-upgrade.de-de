...
* Informationen zum Upgrade von einem AFF A250 auf eine AFF A400 finden Sie unter xref:upgrade-aff_a250_to_aff_a400_ndu_upgrade_workflow.adoc[Upgrade von AFF A250 auf AFF A400 durch Konvertierung in ein Festplatten-Shelf].
