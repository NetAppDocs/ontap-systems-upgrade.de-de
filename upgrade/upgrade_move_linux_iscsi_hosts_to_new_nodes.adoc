...
Nach dem Verschieben der Linux iSCSI-Hosts auf die neuen Knoten, link:upgrade-create-aggregate-move-volumes.html["Ein Aggregat erstellen und Volumes auf die neuen Nodes verschieben"].
